...
exports.OrderKeySpec = void 0;
/* eslint-disable @typescript-eslint/no-unused-vars, @typescript-eslint/no-explicit-any, @typescript-eslint/no-non-null-assertion */
const flatbuffers = __importStar(require("flatbuffers"));
const order_sort_js_1 = require("../sql-schema/order-sort.js");
class OrderKeySpec {
    bb = null;
    bb_pos = 0;
    __init(i, bb) {
    ...
    sort() {
        ...
        return offset ? this.bb.readUint8(this.bb_pos + offset) : order_sort_js_1.OrderSort.DESC_DEFAULT;
    }
    isPk() {
    ...
    static addSort(builder, sort) {
        builder.addFieldInt8(1, sort, order_sort_js_1.OrderSort.DESC_DEFAULT);
    }
...
exports.OrderKeySpec = OrderKeySpec;
