...
import { ColumnConstraint, NullsSortOrder, OrderSort, SQLFilterWrapperType, SQLDataType } from "../types.js";
// ---- JSON → FB enum mappers ----
export function mapOrderSort(v) {
    switch (v) {
...
export function mapFilterType(v) {
...
export function mapConstraint(v) {
    switch (v) {
